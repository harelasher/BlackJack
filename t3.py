                ...
                if table_seat1_mask.get_rect().collidepoint(event.pos) and \
                        table_seat1_mask.get_at(
                            (event.pos[0] - table_seat1_mask.get_rect().x,
                             event.pos[1] - table_seat1_mask.get_rect().y)) and taken_seat is None and game_state["seats"][0]["address"] is None:
                    ...
                    taken_seat = 0
                        ...
                        table_seat2_mask.get_at(
                            (event.pos[0] - table_seat2_mask.get_rect().x,
                             event.pos[1] - table_seat2_mask.get_rect().y)) and taken_seat is None and game_state["seats"][1]["address"] is None:
                    build_and_send_message(conn, PROTOCOL_CLIENT["join_seat"],
                                                     '0' + DATA_DELIMITER + '1')
                    taken_seat = 1
                        ...
                        table_seat3_mask.get_at(
                            (event.pos[0] - table_seat3_mask.get_rect().x,
                             event.pos[1] - table_seat3_mask.get_rect().y)) and taken_seat is None and game_state["seats"][2]["address"] is None:
                    build_and_send_message(conn, PROTOCOL_CLIENT["join_seat"],
                                                     '0' + DATA_DELIMITER + '2')
                    taken_seat = 2
                if taken_seat is not None:
